...
from marm_visual_inspection.srv import *
#模块
import threading
...
def arm_init():                                 #机械臂初始化归位
    gripper_pub=rospy.Publisher('/arm_controller/gripper',Int16,queue_size=1)
